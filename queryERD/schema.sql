...
CREATE TABLE IF NOT EXISTS `gass_livery`.`gass_kan` (
  ...
  `verifikasi` TINYINT(4) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id_transaksi`),
  INDEX `fk_gass_ride_transaksi1_idx` (`id_transaksi` ASC),
  CONSTRAINT `fk_gass_ride_transaksi10`
...
-- -----------------------------------------------------
-- Table `gass_livery`.`gaskan_order`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gass_livery`.`gaskan_order` (
  `id_transaksi` INT(11) NOT NULL,
  `id_tenant` INT(11) NOT NULL,
  `id_menu` INT(11) NOT NULL,
  `jumlah` INT(11) NOT NULL DEFAULT 0,
  `rating_menu` FLOAT NULL DEFAULT 0,
  PRIMARY KEY (`id_transaksi`, `id_tenant`, `id_menu`),
  INDEX `fk_gass_kan_has_tenant_tenant1_idx` (`id_tenant` ASC),
  INDEX `fk_gass_kan_has_tenant_gass_kan1_idx` (`id_transaksi` ASC),
  INDEX `fk_gass_kan_has_tenant_menu1_idx` (`id_menu` ASC),
  CONSTRAINT `fk_gass_kan_has_tenant_gass_kan1`
    FOREIGN KEY (`id_transaksi`)
    REFERENCES `gass_livery`.`gass_kan` (`id_transaksi`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_gass_kan_has_tenant_menu1`
    FOREIGN KEY (`id_menu`)
    REFERENCES `gass_livery`.`menu` (`id_menu`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_gass_kan_has_tenant_tenant1`
    FOREIGN KEY (`id_tenant`)
    REFERENCES `gass_livery`.`tenant` (`id_tenant`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `gass_livery`.`gass_ride` (
  ...
  `titik_antar` TEXT NOT NULL,
  `jarak` INT(11) NOT NULL,
  `driver_wanita` TINYINT(4) NOT NULL DEFAULT 0,
  `kendaraan_baru` TINYINT(4) NOT NULL DEFAULT 0,
  `total_bayar` INT(11) NOT NULL DEFAULT 0,
  `verifikasi` TINYINT(4) NULL DEFAULT 0,
  PRIMARY KEY (`id_transaksi`),
  INDEX `fk_gass_ride_transaksi1_idx` (`id_transaksi` ASC),
